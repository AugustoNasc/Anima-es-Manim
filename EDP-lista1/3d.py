...
class PDEWaveEquationD(Scene):
    def construct(self):
        ...
        equation = MathTex(r"u_t + 3tu_x = u, \, u(x, 0) = \varphi(x)")  # Parte matemática
        ...
        equation_2 = MathTex(r"\left\{\begin{array}{l} \dfrac{d}{ds}t = 1 \\\dfrac{d}{ds}x = 3t \\\dfrac{d}{ds}u = u \end{array}\right.")  # Equações diferenciais
        ...
        # Nova equação
        new_equation_2 = MathTex(r"\left\{\begin{array}{l}t(a, s) = s \\x(a, s) = a + \dfrac{3s^2}{2} \\u(a, s) = e^s\varphi(a)\end{array}\right.")  # Parte matemática
        ...
        equation_2 = MathTex(r"a = x-\dfrac{3t^2}{2}")  # Parte matemática
        ...
        equation_3 = MathTex(r"u(x,t) =  e^s\varphi(a)\\\
                             =e^t\varphi\left(x-\dfrac{3t^2}{2}\right)")  # Solução final
